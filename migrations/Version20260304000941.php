...
final class Version20260304000941 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE publication_reactions (ID_Reaction INT AUTO_INCREMENT NOT NULL, reaction SMALLINT NOT NULL, dateCreation DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, publication_id INT NOT NULL, auteur_id INT NOT NULL, INDEX IDX_2430792438B217A7 (publication_id), INDEX IDX_2430792460BB6FE6 (auteur_id), UNIQUE INDEX uniq_publication_auteur (publication_id, auteur_id), PRIMARY KEY (ID_Reaction)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE publications (ID_Publication INT AUTO_INCREMENT NOT NULL, titre VARCHAR(200) NOT NULL, contenu LONGTEXT DEFAULT NULL, datePublication DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, statut VARCHAR(50) DEFAULT \'active\' NOT NULL, auteur_id INT NOT NULL, INDEX IDX_32783AF460BB6FE6 (auteur_id), INDEX idx_publication_date (datePublication), PRIMARY KEY (ID_Publication)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE recompenses (ID_Recompense INT AUTO_INCREMENT NOT NULL, type VARCHAR(50) DEFAULT NULL, valeur DOUBLE PRECISION DEFAULT NULL, description LONGTEXT DEFAULT NULL, seuil INT DEFAULT NULL, dateObtention DATETIME DEFAULT NULL, livreur_id INT NOT NULL, facture_id INT DEFAULT NULL, INDEX IDX_7A7BAB18F8646701 (livreur_id), INDEX IDX_7A7BAB187F2DEE08 (facture_id), PRIMARY KEY (ID_Recompense)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE vehicules (ID_Vehicule INT AUTO_INCREMENT NOT NULL, marque VARCHAR(50) DEFAULT NULL, modele VARCHAR(50) DEFAULT NULL, immatriculation VARCHAR(20) NOT NULL, type VARCHAR(50) DEFAULT NULL, capacite NUMERIC(10, 2) DEFAULT NULL, statut VARCHAR(50) NOT NULL, problem_description LONGTEXT DEFAULT NULL, technicien_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_78218C2DBE73422E (immatriculation), INDEX IDX_78218C2D13457256 (technicien_id), PRIMARY KEY (ID_Vehicule)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE messenger_messages (id BIGINT AUTO_INCREMENT NOT NULL, body LONGTEXT NOT NULL, headers LONGTEXT NOT NULL, queue_name VARCHAR(190) NOT NULL, created_at DATETIME NOT NULL, available_at DATETIME NOT NULL, delivered_at DATETIME DEFAULT NULL, INDEX IDX_75EA56E0FB7336F0E3BD61CE16BA31DBBF396750 (queue_name, available_at, delivered_at, id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('ALTER TABLE colis ADD CONSTRAINT FK_470BDFF910335F61 FOREIGN KEY (expediteur_id) REFERENCES utilisateurs (id_utilisateur)');
        $this->addSql('ALTER TABLE colis ADD CONSTRAINT FK_470BDFF9A4F84F6E FOREIGN KEY (destinataire_id) REFERENCES utilisateurs (id_utilisateur)');
        ...
        $this->addSql('ALTER TABLE notifications ADD CONSTRAINT FK_6000B0D34D268D70 FOREIGN KEY (colis_id) REFERENCES colis (ID_Colis)');
        $this->addSql('ALTER TABLE publication_reactions ADD CONSTRAINT FK_2430792438B217A7 FOREIGN KEY (publication_id) REFERENCES publications (ID_Publication) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE publication_reactions ADD CONSTRAINT FK_2430792460BB6FE6 FOREIGN KEY (auteur_id) REFERENCES utilisateurs (id_utilisateur) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE publications ADD CONSTRAINT FK_32783AF460BB6FE6 FOREIGN KEY (auteur_id) REFERENCES utilisateurs (id_utilisateur) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE recompenses ADD CONSTRAINT FK_7A7BAB18F8646701 FOREIGN KEY (livreur_id) REFERENCES utilisateurs (id_utilisateur)');
        $this->addSql('ALTER TABLE recompenses ADD CONSTRAINT FK_7A7BAB187F2DEE08 FOREIGN KEY (facture_id) REFERENCES factures (ID_Facture) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE vehicules ADD CONSTRAINT FK_78218C2D13457256 FOREIGN KEY (technicien_id) REFERENCES techniciens (ID_Technicien) ON DELETE SET NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE colis DROP FOREIGN KEY FK_470BDFF910335F61');
        ...
        $this->addSql('ALTER TABLE notifications DROP FOREIGN KEY FK_6000B0D34D268D70');
        $this->addSql('ALTER TABLE publication_reactions DROP FOREIGN KEY FK_2430792438B217A7');
        $this->addSql('ALTER TABLE publication_reactions DROP FOREIGN KEY FK_2430792460BB6FE6');
        $this->addSql('ALTER TABLE publications DROP FOREIGN KEY FK_32783AF460BB6FE6');
        $this->addSql('ALTER TABLE recompenses DROP FOREIGN KEY FK_7A7BAB18F8646701');
        $this->addSql('ALTER TABLE recompenses DROP FOREIGN KEY FK_7A7BAB187F2DEE08');
        $this->addSql('ALTER TABLE vehicules DROP FOREIGN KEY FK_78218C2D13457256');
